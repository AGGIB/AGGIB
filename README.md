...
```javascript
const agybai = {
    name: "Agybai Gibatollaev",
    location: "Astana, Kazakhstan 🇰🇿",
    role: "Full-Stack Developer",
    experience: "2+ years",
    currentProject: "blinq.kz",
    
    workingOn: {
        frontend: ["Next.js", "React.js", "TypeScript", "Tailwind"],
        backend: ["Node.js", "Nest.js", "Go (learning)"],
        mobile: ["Flutter"],
        database: ["PostgreSQL"],
        tools: ["Docker", "Git", "Linux", "Windows 11", "macOS"]
    },
    
    interests: ["Frontend", "Backend", "ML/AI"],
    openToWork: true,
...
class CurrentGoals:
    ...
    def next_milestone(self):
        return "Mastering Go for high-performance backend services"
        
goals = CurrentGoals()
print(f"🎯 Next milestone: {goals.next_milestone()}")
```
...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:agybaygibatollaev@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/agybai-gibatollaev)
[![Telegram](https://img.shields.io/badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/agybai)
